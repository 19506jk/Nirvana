...
import mechanics.character.jobs.Acolyte;
import mechanics.character.jobs.Job;
import mechanics.character.jobs.Rogue;
import mechanics.character.jobs.Swordsman;
import mechanics.enums.JobClass;
import mechanics.enums.PotionType;
...
class PlayerInteract extends Interaction {
	...
	public void move(Obj o) {
		...
		else
		{
			...
			if (ftype == Square.TILE || ftype == Square.DOOR || ftype == Square.GRASS)
			{
				floor.setObj(tr,tc, o);
				floor.setObj(pr, pc, null);
				pr = tr;
